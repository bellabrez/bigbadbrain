...
cmtk reformatx -o ./mean2kevin/${slave::-4}_warped.nii --floating ${slave} ${master} Registration/warp/${master::-4}_${slave}_warp_m0g80c8e1e-1x26r4.list/
