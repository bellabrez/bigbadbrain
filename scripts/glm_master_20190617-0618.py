...
######################################
channels = ['green']
brain_regions = ['optic_functional_3'] # if not nested, put ''
        ...
        for channel in channels:
            ...
            if visual:
                for stimulus in unique_stimuli:
                    ...
                    ### Save brain ###
                    bbb.save_glm_map(scores, betas, directory, channel, param=str(stimulus['background']))
